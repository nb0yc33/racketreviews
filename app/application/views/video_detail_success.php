...
<div class="container">
    ...
    <p> Your upload details have been added successfully! </p>

	<form action="<?=site_url('home/upload');?>" method="post"> 
		<div class="submit-container">
			<input type="submit" name="submit" class="button" value= "RETURN_TO_UPLOAD_VIDEO_AND_THUMBNAIL">
		</div>
	</form>
